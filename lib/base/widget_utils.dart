...
Widget getButtonWithIcon(
  ...
  MainAxisAlignment alignBtn = MainAxisAlignment.spaceBetween,
}) {
  return InkWell(
    onTap: () {
      function();
...
Widget getToolbar(BuildContext context, String title) {
  return Container(
    decoration: BoxDecoration(
